...
@WebServlet("/ConsultarProveedorOrden")
public class ConsultarProveedorOrden extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response){
		...
		try{
			...
			RequestDispatcher disp =  getServletContext().getRequestDispatcher("/consultar_proveedores.jsp");
