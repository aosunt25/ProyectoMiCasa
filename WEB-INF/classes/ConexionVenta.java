...
public class ConexionVenta extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response){
		...
		try{
			...
			String sql = "SELECT * FROM Juguete, Ventas WHERE Juguete.id = '"+id_juguete+"' and Ventas.id ='"+id_venta+"';";
			...
			if(res.next()){
				if(cantidad>res.getInt("Juguete.cantidad")){
					...
					while(resJug.next()){
						...
						juguete.setID(resJug.getInt("id"));
						juguete.setNombre(resJug.getString("nombre"));
