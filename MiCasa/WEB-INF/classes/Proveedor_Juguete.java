...
@WebServlet("/ConsultarProveedor_Juguete")
public class Proveedor_Juguete extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response){
		...
		try{
			...
			RequestDispatcher disp =  getServletContext().getRequestDispatcher("/add_juguete.jsp");
